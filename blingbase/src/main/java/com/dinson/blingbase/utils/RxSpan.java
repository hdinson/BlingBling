...
public final class RxSpan {
    ...
    public static RxSpan with(final TextView textView) {
        return new RxSpan(textView);
    }
    ...
    private RxSpan(TextView textView) {
        this();
        mTextView = textView;
    }
     ...
     *             </ul>
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setBullet(@ColorInt final int color,
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setFontProportion(final float proportion) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setFontXProportion(final float proportion) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setStrikethrough() {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setHorizontalAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setVerticalAlign(@Align final int align) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setClickSpan(@ColorInt final int color,
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setUrl(@NonNull final String url) {
        if (mTextView != null && mTextView.getMovementMethod() == null) {
            mTextView.setMovementMethod(LinkMovementMethod.getInstance());
        }
        this.url = url;
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                             final Blur style) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final float dx,
                               final float dy,
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link RxSpan} instance
     */
    public RxSpan appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
