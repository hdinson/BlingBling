package com.dinson.blingbase.widget.acrlayout;
...
import com.dinson.blingbase.widget.acrlayout.manager.ClipPathManager;
...
public class ArcLayout extends ShapeOfView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            arcHeight = attributes.getDimensionPixelSize(R.styleable.ArcLayout_alHeight, arcHeight);
            arcPosition = attributes.getInteger(R.styleable.ArcLayout_alPosition, arcPosition);
            cropDirection = attributes.getInteger(R.styleable.ArcLayout_alCropDirection, cropDirection);
            attributes.recycle();
        }
