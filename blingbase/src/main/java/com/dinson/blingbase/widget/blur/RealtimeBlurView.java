...
public class RealtimeBlurView extends View {
	...
	public RealtimeBlurView(Context context, AttributeSet attrs) {
		...
		mBlurRadius = a.getDimension(R.styleable.RealtimeBlurView_rbvBlurRadius,
				TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, context.getResources().getDisplayMetrics()));
		mDownsampleFactor = a.getFloat(R.styleable.RealtimeBlurView_rbvDownsampleFactor, 4);
		mOverlayColor = a.getColor(R.styleable.RealtimeBlurView_rbvOverlayColor, 0xAAFFFFFF);
		a.recycle();
