...
public class MarqueeView<T> extends ViewFlipper {
    ...
    @AnimRes
    private int inAnimResId = R.anim.marquee_bottom_in;
    @AnimRes
    private int outAnimResId = R.anim.marquee_top_out;
        ...
        if (typedArray.hasValue(R.styleable.MarqueeViewStyle_mvDirection)) {
            ...
            switch (direction) {
                case DIRECTION_BOTTOM_TO_TOP:
                    inAnimResId = R.anim.marquee_bottom_in;
                    outAnimResId = R.anim.marquee_top_out;
                    break;
                case DIRECTION_TOP_TO_BOTTOM:
                    inAnimResId = R.anim.marquee_top_in;
                    outAnimResId = R.anim.marquee_bottom_out;
                    break;
                case DIRECTION_RIGHT_TO_LEFT:
                    inAnimResId = R.anim.marquee_right_in;
                    outAnimResId = R.anim.marquee_left_out;
                    break;
                case DIRECTION_LEFT_TO_RIGHT:
                    inAnimResId = R.anim.marquee_left_in;
                    outAnimResId = R.anim.marquee_right_out;
                    break;
            }
        } else {
            inAnimResId = R.anim.marquee_bottom_in;
