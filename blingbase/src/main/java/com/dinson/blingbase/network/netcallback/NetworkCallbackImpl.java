package com.dinson.blingbase.network.netcallback;
...
import com.dinson.blingbase.network.core.MethodManager;
...
public class NetworkCallbackImpl extends ConnectivityManager.NetworkCallback {
    ...
    private List<MethodManager> findAnnotationMethods(Object observer) {
        ...
        for (Method method : methods) {
            //获取方法注解
            AppNetwork network = method.getAnnotation(AppNetwork.class);
            if (network == null) {
                continue;
            }
            //方法参数校验
