package dinson.customview.weight._029floatingview;
...
import dinson.customview.weight._029floatingview.transition.FloatingTransition;
...
public class Floating {
    ...
    public void startFloating(FloatingElement floatingElement) {
        ...
        if (targetView == null){
            targetView = LayoutInflater.from(anchorView.getContext()).inflate(floatingElement.targetViewLayoutResId,null,false);
        }
        ...
        mFloatingDecorView.removeView(targetView);
