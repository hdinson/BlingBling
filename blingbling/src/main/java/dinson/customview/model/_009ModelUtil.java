...
public class _009ModelUtil {
    ...
    private static final String[] descArr = {
        "北京故宫于明成祖永乐四年（1406年）开始建设，以南京故宫为蓝本营建，到永乐十八年（1420年）建成。它是一座长方形城池，南北长961米，东西宽753米，四面围有高10米的城墙，城外有宽52" +
            "米的护城河。紫禁城内的建筑分为外朝和内廷两部分。外朝的中心为太和殿、中和殿、保和殿，统称三大殿，是国家举行大典礼的地方。内廷的中心是乾清宫、交泰殿、坤宁宫，统称后三宫，是皇帝和皇后居住的正宫。",
        ...
        "香港，全称为中华人民共和国香港特别行政区（HKSAR" +
            "）。地处中国华南地区，珠江口以东，南海沿岸，北接广东省深圳市，西接珠江，与澳门特别行政区、珠海市以及中山市隔着珠江口相望。高度繁荣的国际大都市，全境由香港岛、九龙半岛、新界等3" +
            "大区域组成，人口密度居全世界第三。1842-1997年间，香港曾为英国殖民地。二战以后，香港经济和社会迅速发展，不仅被誉为“亚洲四小龙”之一，更成为全球最富裕、经济最发达和生活水准最高的地区之一。",
        "地球（Earth）是太阳系八大行星之一，按离太阳由近及远的次序排为第三颗，也是太阳系中直径、质量和密度最大的类地行星，距离太阳1.5亿公里。地球自西向东自转，同时围绕太阳公转。现有40~46亿岁，[1]  " +
        ...
        "哈利法塔最初的原名叫迪拜塔，完工之后才改以哈利法塔为正式名称。在古阿拉伯世界中，哈利法为“伊斯兰世界最高领袖”之意，同时也是历史上阿拉伯帝国统治者的称号。高828米，楼层总数162层，造价15亿美元，共使用33" +
            "万立方米混凝土、6.2万吨强化钢筋，14.2万平方米玻璃。共调用了大约4000名工人和100台起重机，把混凝土垂直泵上逾606米的地方。大厦内设有56部升降机，速度最高达17.4" +
            "米/秒，另外还有双层的观光升降机，每次最多可载42人。",
        "圣托里尼岛(Santorini)古名为希拉(Thera)，后来为纪念圣·爱莲（SaintIrene），于1207年被改为圣托里尼。圣托里尼（Santorini）是在希腊大陆东南200" +
            "公里的爱琴海上由一群火山组成的岛环，圣托里尼岛环上最大的一个岛也叫圣托里尼岛，别名锡拉岛（Thira）。",
        "马尔代夫全称：马尔代夫共和国位于南亚，是印度洋上的一个岛国，也是世界上最大的珊瑚岛国。由1200余个小珊瑚岛屿组成，其中202个岛屿有人居住，从空中鸟瞰就像一串珍珠撒在印度洋上。面积298" +
            "平方公里（不计算领海），是亚洲最小的国家。",
        "瑞喜敦岛座纯净天然的小岛位于世界上最大及最深的环礁Caafu Alifu Atoll之中，棕榈树摇曳生姿,沙滩洁白细软。绵延无尽:珊瑚礁色彩斑谰。各种绮丽的海洋植物丛生,与周围海面交织．蔚为壮观" +
            ".岛上．郁郁葱葱，清凉舒适．伊然另番景色；在这里，您可以探索自然的植物和动物亦对拜访岛屿附近的村庄,体验传统马尔代夫文化。此岛位1千米,宽120米，景色优美,举世无双,乃一座绝以桃花源,可谓美而不娇," +
            "悠然静谧,惊为仙境。居于此岛,远离尘嚣,遗世而独立。",
        ...
        "尼亚加拉瀑布(Niagara Falls)" +
            "位于加拿大安大略省和美国纽约州的交界处，瀑布源头为尼亚加拉河，主瀑布位于加拿大境内，是瀑布的最佳观赏地；在美国境内瀑布由月亮岛隔开，观赏的是瀑布侧面。同时，该瀑布也是世界第一大跨国瀑布。尼亚加拉瀑布也直译作拉格科瀑布，“尼亚加拉”在印第安语中意为“雷神之水”，印第安人认为瀑布的轰鸣是雷神说话的声音。"
    };
