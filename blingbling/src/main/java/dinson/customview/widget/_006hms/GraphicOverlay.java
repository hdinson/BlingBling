package dinson.customview.widget._006hms;
...
import dinson.customview.widget._006hms.camera.CameraConfiguration;
import dinson.customview.widget._006hms.graphic.BaseGraphic;
...
public class GraphicOverlay extends View {
    ...
    private final ArrayList<BaseGraphic> graphics = new ArrayList<>();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        synchronized (this.lock) {
            if ((this.previewWidth != 0) && (this.previewHeight != 0)) {
                this.widthScaleValue = (float) getWidth() / (float) this.previewWidth;
                this.heightScaleValue = (float) getHeight() / (float) this.previewHeight;
            }
