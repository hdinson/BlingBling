...
public class Transition {
    ...
    public Transition(RectF srcRect, RectF dstRect, long duration, Interpolator interpolator) {
        if (!MathUtils.haveSameAspectRatio(srcRect, dstRect)) {
            throw new RuntimeException("Helper class to perform math computations.");
        }
        mSrcRect = srcRect;
        mDstRect = dstRect;
        mDuration = duration;
     ...
     * @param elapsedTime the elapsed times since this transition started.
     */
