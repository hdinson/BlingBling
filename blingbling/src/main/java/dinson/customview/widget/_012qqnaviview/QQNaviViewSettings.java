package dinson.customview.widget._012qqnaviview;
...
public class QQNaviViewSettings {
    ...
    QQNaviViewSettings(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBigIconSrc = ta.getResourceId(R.styleable.QQNaviView_bigIconSrc, R.drawable._012_bubble_big);
        mBigIconSrcCheck = ta.getResourceId(R.styleable.QQNaviView_bigIconSrcCheck, R.drawable._012_pre_bubble_big);
