 ...
 */
class _004RightAdapter(context: Context, dataList: List<MonsterHunter.DataBean.MonsterBean>)
    : CommonAdapter<MonsterBean>(context, dataList) {

    override fun getLayoutId(viewType: Int)
        = if (viewType == 0) R.layout.item_004_right_title else R.layout.item_004_right_normal
