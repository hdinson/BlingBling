...
public class QQNaviView extends LinearLayout {
    ...
    /* 外层icon资源 */
    private int mBigIconSrc, mBigIconSrcCheck;

    /* 里面icon资源 */
    private int mSmallIconSrc, mSmallIconSrcCheck;
    ...
    public QQNaviView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        mIconWidth = ta.getDimension(R.styleable.QQNaviView_iconWidth, dp2px(context, 40));
        mIconHeight = ta.getDimension(R.styleable.QQNaviView_iconHeight, dp2px(context, 40));
    ...
    private void init(Context context) {
        mView = inflate(context, R.layout.view_002_icon, null);
...
//    }
    ...
    public void setChecked(boolean checked) {
        mBigIcon.setImageResource(checked ? mBigIconSrcCheck : mBigIconSrc);

        mSmallIcon.setImageResource(checked ? mSmallIconSrcCheck : mSmallIconSrc);
    }
}