...
import dinson.customview.weight.flexibleimageview.RandomTransitionGenerator;
import dinson.customview.weight.flexibleimageview.Transition;
import dinson.customview.weight.flexibleimageview.TransitionGenerator;
...
public class FlexibleImageView extends AppCompatImageView {
    ...
    /**
     * The implementation used to perform the transitions between rects.
     *
     */
