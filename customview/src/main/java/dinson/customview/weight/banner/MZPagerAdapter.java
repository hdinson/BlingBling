...
public class MZPagerAdapter<T> extends PagerAdapter {
    ...
    private View getView(int position, ViewGroup container) {
        ...
        // create holder
       /* holder = mMZHolderCreator.createView(container.getContext());

        if (holder == null) {
            throw new RuntimeException("can not return a null holder");
        }*/
        // create View
        View view = mMZHolderCreator.createView(container.getContext());
