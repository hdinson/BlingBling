...
class _013StepViewActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list0.add("您的订单预计6月23日送达您的手中，618期间促销火爆，可能影响送货时间，请您谅解，我们会第一时间送到您的手中您的订单预计6月23日送达您的手中，618期间促销火爆，可能影响送货时间，请您谅解，我们会第一时间送到您的手中您的订单预计6月23日送达您的手中，618期间促销火爆，可能影响送货时间，请您谅解，我们会第一时间送到您的手中")
        list0.add("您的订单已打印完毕")
        list0.add("您的订单已拣货完成")
        list0.add("扫描员已经扫描")
        list0.add("打包成功")
        ...
        step_view0.setStepsViewIndicatorCompletingPosition(list0.size - 1)//设置完成的步数
            ...
            .setStepsViewIndicatorUnCompletedLineColor(ContextCompat.getColor(this, R.color.green))//设置StepsViewIndicator未完成线的颜色
            .setStepViewCompletedTextColor(ContextCompat.getColor(this, android.R.color.white))//设置StepsView text完成线的颜色
            .setStepViewUnCompletedTextColor(ContextCompat.getColor(this, R.color.yellow))//设置StepsView text未完成线的颜色
